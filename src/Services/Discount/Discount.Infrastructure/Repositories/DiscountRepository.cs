...
namespace Discount.Infrastructure.Repositories
{
    public class DiscountRepository : IDiscountRepository
    {
        ...
        public async Task<bool> CreateDiscount(Coupon coupon)
        {
            ...
            var affected = await connection.ExecuteAsync(@"INSERT INTO 
                                                                    Coupon (ProductName, Description, Amount) 
        ...
        public async Task<bool> UpdateDiscount(Coupon coupon)
        {
            ...
            var affected = await connection.ExecuteAsync(@"UPDATE Coupon SET ProductName = @ProductName,
                                                                             ...
                                                                             Amount = @Amount
                                                            WHERE Id = @Id", new {ProductName = coupon.ProductName, Description = coupon.Description, Amount = coupon.Amount, Id = coupon.Id });
